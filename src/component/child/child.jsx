...
const Child = ({ childData }) => {
    ...
    return (
        <div className={styles.childDiv}>
            <button className={styles.childBtn} onClick={() => twoSubOne_two(childData.id, childData)}>
                <img src={imgSrc} className={styles.childImg}></img>
            </button>
            <div className={styles.childDetail} onClick={() => twoSubOne_two(childData.id, childData)}>
                ...
                {/* <GaugeGraph percent={childData.percent}></GaugeGraph> */}
            </div>
